...
edf <- effective_df(train_y, train_x, kern = kernel_k_nearest_neighbors, k=12)
...
Minimum test error occurs when k = 14, we select k = 20 because it is one standard deviation away from the minimum but with the highest k value (parsimonious model). 
